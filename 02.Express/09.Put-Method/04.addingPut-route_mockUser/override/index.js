...
app.get("/getUser_order",(req,res)=>{/* /getUser_order?sort=value */
...
app.get("/user/get",(req,res)=>{/* /user/get?id=value */
    const {query:{id}}=req;
...
app.get("/:user_name",(req,res)=>{/* /Shivansh , /Alex */
...
app.post("/queryCreate",(req,res)=>{
    ...
    for(let i=0;i<userData.length;i++)
    {
        //checking if the uid enter in query is reapeate or not
    ...
    //if not repeated id that is flag true then push it inot db
    if(flag)
    {

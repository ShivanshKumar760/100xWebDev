...
export const queryCreate_Schema={
    uid:{
        in:['query'],
        toInt:true,
        isNumeric:{errorMessage:"user id should be number"}
    },

    firstName:{
        in:['query'],
        notEmpty:{errorMessage:"user name cannot be empty"},
        isLength:{options:{min:4,max:32},errorMessage:"User name must be atleat 4 character long and max 32 character long"},
        isString:{errorMessage:"User Name must be a string"}
    },

    age:{
        in:['query'],
        notEmpty:{errorMessage:"Age should not be empty"},
